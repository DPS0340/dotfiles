...
mountpoint ~/.ssh/remote || nohup rclone mount --allow-non-empty --log-level ERROR --allow-other --uid $_UID --gid $_GID --vfs-cache-mode full google-drive:auth ~/.ssh/remote >> ~/dotfiles/nohup-rclone.out 2>&1 &

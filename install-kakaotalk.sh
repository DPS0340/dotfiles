...
rm -f malgun.ttf KakaoTalk_Setup.exe
...
cat ~/.wine/system.reg \
	| sed -En 's/"MS Shell Dlg"="Tahoma"/"MS Shell Dig"="Malgun Gothic"/g' \
	| sed -En 's/"MS Shell Dlg 2"="Tahoma"/"MS Shell Dig 2"="Malgun Gothic"/g' \
